...
if($_POST['subject'] == 1){
    $subject='Юридическая помощь';
}
elseif($_POST['subject'] == 2){
    $subject='Поиск пропавшего безвести';
}
...
if(mail($to, $subject, $message, $headers)){
    ...
    header('Refresh: 3; URL= http://localhost/unionsvo/help.php');//прописывается домен для перенаправления
}
else{
